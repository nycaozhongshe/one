<template>
	<div id="title">
		<m-header :headShow="true">一个音乐</m-header>
...
<script>
	...
	export default {
		...
		created() {
			this.$http.get('http://v3.wufazhuce.com:8000/api/channel/music/more/0?channel=wdj&version=4.0.2&uuid=ffffffff-a90e-706a-63f7-ccf973aae5ee&platform=android')
				.then(
					(data) => {
		...
		methods: {
			...
			refresh() {
				this.onList = 'http://v3.wufazhuce.com:8000/api/channel/music/more/'
